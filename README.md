...
[![GitHub license](https://img.shields.io/github/license/YOUR_USERNAME/dd-reinstall)](https://github.com/YOUR_USERNAME/dd-reinstall/blob/main/LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/YOUR_USERNAME/dd-reinstall)](https://github.com/YOUR_USERNAME/dd-reinstall/stargazers)
...
**海外服务器:**
```bash
curl -O https://raw.githubusercontent.com/YOUR_USERNAME/dd-reinstall/main/reinstall.sh && chmod +x reinstall.sh
```

**国内服务器:**
```bash
curl -O https://ghproxy.com/https://raw.githubusercontent.com/YOUR_USERNAME/dd-reinstall/main/reinstall.sh && chmod +x reinstall.sh
```
